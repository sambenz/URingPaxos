...
#JVM_OPTS="-XX:+PrintCommandLineFlags -XX:+PrintGCDetails"
#JVM_OPTS="$JVM_OPTS -XX:+HeapDumpOnOutOfMemoryError
#JVM_OPTS="$JVM_OPTS -XX:+UseG1GC"
#JVM_OPTS="$JVM_OPTS -XX:+UseParallelGC -XX:NewRatio=1"
...
# start the program
$JAVA -Djava.library.path=$PRGDIR/lib -cp $PRGDIR/lib:$CLASSPATH -Xms2G -Xmx2G $JVM_OPTS ch.usi.da.paxos.examples.TTYNode $@
