...
public class Command implements org.apache.thrift.TBase<Command, Command._Fields>, java.io.Serializable, Cloneable, Comparable<Command> {
  ...
  public int compareTo(Command other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPartition_version()).compareTo(other.isSetPartition_version());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMap_number()).compareTo(other.isSetMap_number());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMap_number()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetValue2()).compareTo(other.isSetValue2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetValue2()) {
